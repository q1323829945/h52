<!--
 * @Author       : Nimo
 * @FilePath     : /bdo-management/src/views/admin/apply/loan/applicationProduct/kabuhayanProduct.vue
 * @Date         : 2022-08-12 14:48:32
 * @LastEditTime : 2022-11-04 17:11:03
 * @LastEditors  : Nimo
 * @Logs         : 
 * 
-->
...
import config from '../optsConfig/kabuhayanProductConfig'
...
export default {
  ...
  methods: {
    ...
    requstBaseData(requestBody = {}) {
      ...
      console.log('body.isHaneld==>', body.isHaneld)
      this.$api
        ...
        .then(res => {
          ...
          if (body.isHaneld) {
            ...
            console.log('kabu requstBaseData==>', this.detailObj.model)
          }
        })
        .catch(msg => {
          this.loading = false
