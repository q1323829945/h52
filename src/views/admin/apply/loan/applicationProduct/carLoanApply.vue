<!--
 * @Author       : Nimo
 * @FilePath     : /car-management/src/views/admin/apply/loan/applicationProduct/carLoanApply.vue
 * @Date         : 2022-11-25 14:25:27
 * @LastEditTime : 2022-12-02 17:10:31
 * @LastEditors  : Nimo
 * @Logs         : 
 * 
-->
...
import CarApplyWidgets from '../components/carApplyWidgets/index.vue'
...
export default {
  ...
  methods: {
     ...
     */
    setWidgets() {
      let widgetOpts = JSON.parse(JSON.stringify(config.carWidgetOpts))
      // 追加产品类型widget
      var objArr = []
    ...
    handleEdit() {
      ...
      this.$refs.CarProductWidgets.$refs.moblieApplyFormData.clearValidate()
