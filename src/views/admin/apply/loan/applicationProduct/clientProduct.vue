<!--
 * @Author       : Nimo
 * @FilePath     : /bdo-management/src/views/admin/apply/loan/applicationProduct/clientProduct.vue
 * @Date         : 2022-08-12 14:48:23
 * @LastEditTime : 2022-11-04 17:19:48
 * @LastEditors  : Nimo
 * @Logs         : 
 * 
-->
<template>
  <app-main>
    ...
    >
      <Client-Product-Widgets ref="ClientProductWidgets" :isEdit="isEdit" :widgetOpts="detailObj.widgetOpts" :model="detailObj.model" />
    </div>
  </app-main>
</template>
...
import config from '../optsConfig/clientProductCongfig'
