/*
 * @Author       : Nimo
 * @FilePath     : /car-management/src/views/admin/apply/loan/optsConfig/apply-i18n.js
 * @Date         : 2022-07-21 14:32:19
 * @LastEditTime : 2022-12-05 10:04:33
 * @LastEditors  : Nimo
 * @Logs         :
 *
 */
...
const apply_title_zh = {
  applyTitle: '贷款申请',
  applyDetailTitle: '贷款申请详情',
  ...
  moblieClientTitle: 'Agent Apply Detail',

  carProductApplyTitle: '汽车贷款申请',
  carProductTitle: '汽车贷款'
}
const apply_title_en = {
  applyTitle: 'Loan Application',
  applyDetailTitle: 'Loan Application Detail',
  loanStatisticalTitle: 'Loan Statistical',
  commissionStatisticalTitle: 'Commission',

  teacherProductTitle: 'Teacher Loan',
  newClientProductTitle: 'New Client Loan',
  ...
  carProductApplyTitle: 'Auto Agent',
  carProductTitle: 'Auto Loan'
}

const apply_menu_tree_zh = {
  applyTitle: 'Loan Application',
  applyDetailTitle: 'Loan Application Detail',
  loanStatisticalTitle: 'Loan Statistical',
  commissionStatisticalTitle: 'Commission',
