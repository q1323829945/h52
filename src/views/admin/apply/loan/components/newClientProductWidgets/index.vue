<!--
 * @Author       : Nimo
 * @FilePath     : /bdo-management/src/views/admin/apply/loan/components/newClientProductWidgets/index.vue
 * @Date         : 2022-08-12 16:06:34
 * @LastEditTime : 2022-11-02 10:48:59
 * @LastEditors  : Nimo
 * @Logs         : 
 * 
-->
          ...
          <div>
            ...
            >
              ...
              <el-date-picker
                ...
                @input="$forceUpdate()"
                @change="getBirthDate($event, customerItem.key)"
          ...
          <div>
            ...
            >
              ...
              <el-date-picker
                ...
                @change="getBirthDate($event, internalItem.key)"
                v-model="modelTemp[`${widgetOpts.internal.section}`][internalItem.key]"
                :readonly="!isEdit"
                :format="internalItem.valueFormat || 'yyyy-MM-dd'"
                type="date"
                :placeholder="$t(internalItem.placeholder)"
              />
            </el-form-item>
