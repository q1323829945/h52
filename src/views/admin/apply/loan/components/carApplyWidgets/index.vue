<!--
 * @Author       : Nimo
 * @FilePath     : /car-management/src/views/admin/apply/loan/components/carApplyWidgets/index.vue
 * @Date         : 2022-11-25 14:58:07
...
<template>
  <div class="detail-base">
    <el-form ref="moblieApplyFormData" :inline="true" :model="modelTemp" size="small" :label-width="labelWidth" @submit.native.prevent>
      ...
      <div v-if="modelTemp.carPurchaseInformation">
        <div class="datasource">
          <div class="section">
            {{ $t(widgetOpts.carPurchaseInformation.title) }}
          </div>
          <!-- 基础信息 -->
          <div>
            <el-form-item
              :style="{ width: setSysComputedWidth({ en: 410, zh: 410 }), margin: '0px 10px 16px 0px' }"
              v-for="(personalItem, personalIndex) in widgetOpts.carPurchaseInformation.widgets"
              :key="widgetOpts.personalInformation.section + personalIndex"
              :label-width="setComputedWidth({ en: 210, zh: 210 })"
              :label="$t(personalItem.label)"
              :prop="`${[personalItem.key]}`"
            >
              <el-input
                v-if="personalItem.type === 'input'"
                v-model="modelTemp[`${widgetOpts.carPurchaseInformation.section}`][personalItem.key]"
          ...
          <!-- .carPurchaseInformation.carInformation -->
          <div v-if="modelTemp.carPurchaseInformation.carInformation">
            <div class="subInfo-view">
              <div class="section section-padding">
                {{ $t(widgetOpts.carPurchaseInformation.carInformation.title) }}
              </div>
              <div>
                <el-form-item
                  :style="{ width: setSysComputedWidth({ en: 380, zh: 380 }), margin: '0px 10px 16px 0px' }"
                  v-for="(nameItem, nameIndex) in widgetOpts.carPurchaseInformation.carInformation.widgets"
                  :key="widgetOpts.carPurchaseInformation.carInformation.title + nameIndex"
                  :label-width="setComputedWidth({ en: 180, zh: 180 })"
                ...
                >
                  <el-input
                    ...
                    v-model="
                      modelTemp[`${widgetOpts.carPurchaseInformation.section}`][`${widgetOpts.carPurchaseInformation.carInformation.key}`][
                        nameItem.key
                      ]
                    "
          ...
          <!-- .carPurchaseInformation.carDrivingLicenseInformation -->
          <div v-if="modelTemp.carPurchaseInformation.carDrivingLicenseInformation">
            <div class="subInfo-view subInfo-margin">
              <div class="section section-padding">
                {{ $t(widgetOpts.carPurchaseInformation.carDrivingLicenseInformation.title) }}
              </div>
              <div>
                <el-form-item
                  :style="{ width: setSysComputedWidth({ en: 300, zh: 300 }), margin: '0px 10px 16px 0px' }"
                  v-for="(nameItem, nameIndex) in widgetOpts.carPurchaseInformation.carDrivingLicenseInformation.widgets"
                  :key="widgetOpts.carPurchaseInformation.carDrivingLicenseInformation.title + nameIndex"
                ...
                >
                  <el-input
                    v-if="nameItem.type === 'input'"
                    v-model="
                      modelTemp[`${widgetOpts.carPurchaseInformation.section}`][
                        `${widgetOpts.carPurchaseInformation.carDrivingLicenseInformation.key}`
                      ][nameItem.key]
                    "
                    :placeholder="$t(nameItem.placeholder)"
                    :disabled="true"
          ...
          <!-- .carPurchaseInformation.carRegistrationCertificateInformation -->
          <div v-if="modelTemp.carPurchaseInformation.carRegistrationCertificateInformation">
            <div class="subInfo-view subInfo-margin">
              <div class="section section-padding">
                {{ $t(widgetOpts.carPurchaseInformation.carRegistrationCertificateInformation.title) }}
              </div>
              <div>
                <el-form-item
                  :style="{ width: setSysComputedWidth({ en: 320, zh: 300 }), margin: '0px 10px 16px 0px' }"
                  v-for="(nameItem, nameIndex) in widgetOpts.carPurchaseInformation.carRegistrationCertificateInformation.widgets"
                  :key="widgetOpts.carPurchaseInformation.carRegistrationCertificateInformation.title + nameIndex"
                  :label-width="setComputedWidth({ en: 120, zh: 100 })"
                  :label="$t(nameItem.label)"
                  :prop="`${[nameItem.key]}`"
                >
                  <el-input
                    ...
                    v-model="
                      modelTemp[`${widgetOpts.carPurchaseInformation.section}`][
                        `${widgetOpts.carPurchaseInformation.carRegistrationCertificateInformation.key}`
                      ][nameItem.key]
                    "
                    :placeholder="$t(nameItem.placeholder)"
                    :disabled="true"
                ...
                <div>
                  ...
                  >
                    <el-input
                      v-if="nameItem.type === 'input'"
                      v-model="
                        modelTemp[`${widgetOpts.personalInformation.section}`][`${widgetOpts.personalInformation.spouseInformation.key}`][
                          `${widgetOpts.personalInformation.spouseInformation.name.key}`
                        ][nameItem.key]
                      "
                      :placeholder="$t(nameItem.placeholder)"
                      :disabled="true"
