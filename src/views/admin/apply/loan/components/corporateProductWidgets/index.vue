<!--
 * @Author       : Nimo
 * @FilePath     : /bdo-management/src/views/admin/apply/loan/components/corporateProductWidgets/index.vue
 * @Date         : 2022-08-12 16:06:34
 * @LastEditTime : 2022-11-02 11:14:10
 * @LastEditors  : Nimo
 * @Logs         : 
 * 
-->
            ...
            >
              ...
              >
                ...
                <el-date-picker
                  ...
                  @input="$forceUpdate()"
                  @change="getListBirthDate(widgetOpts.partnersInformation.section, partnersIndex, $event)"
                  v-if="widgetsItem.type === 'date'"
                  v-model="modelTemp[`${widgetOpts.partnersInformation.section}`][partnersIndex]['name'][widgetsItem.key]"
                  :readonly="!isEdit"
                  :format="widgetsItem.valueFormat || 'MM-dd-yyyy'"
                  type="date"
                  :placeholder="$t(widgetsItem.placeholder)"
                ></el-date-picker>
              </el-form-item>
          ...
          <div>
            ...
            >
              ...
              <el-date-picker
                :style="{ width: setSysComputedWidth({ en: 182, zh: 182 }) }"
                @input="$forceUpdate()"
                @change="getBirthDate($event, widgetOpts.mortgagorInformation.section)"
                v-if="mortgagoWidgetItem.type === 'date'"
                v-model="modelTemp[`${widgetOpts.mortgagorInformation.section}`][mortgagoWidgetItem.key]"
                :readonly="!isEdit"
                :format="mortgagoWidgetItem.valueFormat || 'MM-dd-yyyy'"
                type="date"
                :placeholder="$t(mortgagoWidgetItem.placeholder)"
              ></el-date-picker>
            </el-form-item>
          ...
          <div>
            ...
            >
              ...
              <el-date-picker
                :style="{ width: setSysComputedWidth({ en: 182, zh: 182 }) }"
                @input="$forceUpdate()"
                @change="getBirthDate($event, widgetOpts.spouseInformation.section)"
                v-if="spouseInformationItem.type === 'date'"
                v-model="modelTemp[`${widgetOpts.spouseInformation.section}`][spouseInformationItem.key]"
                :readonly="!isEdit"
                :format="spouseInformationItem.valueFormat || 'MM-dd-yyyy'"
                type="date"
                :placeholder="$t(spouseInformationItem.placeholder)"
              ></el-date-picker>
            </el-form-item>
              ...
              >
                ...
                >
                  ...
                  <el-date-picker
                    :style="{ width: setSysComputedWidth({ en: 182, zh: 182 }) }"
                    @input="$forceUpdate()"
                    @change="getListBirthDate(widgetOpts.financialInformation.deposits.key, depositsIndex, $event)"
                    v-if="widgetsItem.type === 'date'"
                    v-model="
                      modelTemp[`${widgetOpts.financialInformation.section}`][widgetOpts.financialInformation.deposits.key][depositsIndex][
                        widgetsItem.key
                    ...
                    "
                    :readonly="!isEdit"
                    :format="widgetsItem.valueFormat || 'MMyyyy'"
                    type="date"
                    :placeholder="$t(widgetsItem.placeholder)"
                  ></el-date-picker>
                </el-form-item>
              ...
              >
                ...
                >
                  ...
                  <el-date-picker
                    :style="{ width: setSysComputedWidth({ en: 182, zh: 182 }) }"
                    v-if="widgetsItem.type === 'date'"
                    @change="getListBirthDate(widgetOpts.financialInformation.loans.key, loansIndex, $event, widgetsItem.key)"
                    v-model="
                      modelTemp[`${widgetOpts.financialInformation.section}`][widgetOpts.financialInformation.loans.key][loansIndex][widgetsItem.key]
                    "
                    :readonly="!isEdit"
                    :format="widgetsItem.valueFormat || 'yyyyMMdd'"
                    type="date"
                    :placeholder="$t(widgetsItem.placeholder)"
                  ></el-date-picker>
                </el-form-item>
