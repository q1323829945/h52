<!--
 * @Author       : Nimo
 * @FilePath     : /bdo-management/src/views/admin/customerOffer/applicationProduct/newClientProduct.vue
 * @Date         : 2022-08-12 14:48:09
 * @LastEditTime : 2022-09-23 16:31:26
 * @LastEditors  : Nimo
 * @Logs         : 
 * 
-->
      ...
      this.$api
        ...
        .then(res => {
          ...
          if (body.isHaneld) {
            ...
            if (data.internal) {
              let openedDate = utils.fomartDate(new Date(data.internal.openedDate), '{y}-{m}-{d}')
              data.internal.openedDate = openedDate
            }
